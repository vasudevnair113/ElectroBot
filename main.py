...
print("Indexed (I): Price per kWh changes based on a formula that is calculated by TDU company.")
print()
...
for Deal in DealList:
  ...
  print()
  if Deal[1]["[TermValue]"] != "0":
    print("CONTRACT LENGTH: " + Deal[1]["[TermValue]"] + " Months")
    print()
